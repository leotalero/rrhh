...
<%--			<b>Ventas selecionadas:</b>&nbsp;&nbsp;&nbsp;<span class="enlace" id="enviar_correo_usuario">enviar por correo</span>--%>
			...
			<div id="divempleados" >
			<table style="width:100%" border="0" id="empleados" class="tExcel tRowSelect">
			  ...
			  <tr style="color: ${empleado.estado==2?'':'red'};">
			    ...
			    <td><fmt:formatDate value="${empleado.fechanacimiento}" pattern="dd/MM/yyyy"/></td>
			 	...
			 	<td><fmt:formatDate value="${empleado.fechamod}" pattern="dd/MM/yyyy H:mm"/></td>	
			  	<td>
			  		<c:out value="${empleado.idusuariomod} "/>
			  	</td>		  		  	
			  	<td valign="middle" align="center">
			  		<span class="enlace" onclick="agregarComoTestigo(${empleado.idempleado},${idDisciplina},${idSancion},${idContrato},${idFalta});" title="Agregar"><img alt="Detalle" src="${ctx}/imagen/ico-editar.gif">
			  		</span>
			  	</td>	
			  </tr>			 
			  </c:forEach>			  
