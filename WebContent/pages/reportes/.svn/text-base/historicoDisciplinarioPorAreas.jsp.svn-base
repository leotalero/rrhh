...
//  		alert('Va actualizar: '+idcontrato);
	...
	/*
	 * Actualizar datos del histórico disciplinario.
	 */
...
<c:choose>
		<c:when test="${empty listaDisciplina}">
			...
			-->
			<div class="msgInfo1" align="left">No existen Procesos Disciplinarios para el área y rango de fechas seleccionados.</div>
		</c:when>
		<c:otherwise>
